...
const CounterAnimation: React.FC<CounterAnimationProps> = ({ end, duration = 2000 }) => {
...
const KeyFactsSection = () => {
    const factsData = [
        ...
        { icon: Users, value: 150, label: "Players Selected (100 M + 50 F)", suffix: "+" },
        { icon: Building, value: 8, label: "Franchise Teams" },
        { icon: Calendar, value: 45, label: "Gurukul Style Training Camp" },
        { icon: Tv, value: 36, label: "TV Episodes" },
        { icon: Trophy, value: 10, label: "Teams (6 Male + 4 Female)" },
        { icon: Award, value: 32, label: "Matches (22 Men + 10 Women)" },
            ...
            <div className="container px-4 md:px-6 mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-10">
                    {factsData.map((fact, index) => {
                        ...
                        return (
                            <Card key={index} className="text-center overflow-hidden group hover:border-orange-300 transition-all hover:shadow-md">
