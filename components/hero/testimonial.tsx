...
export function TestimonialHero() {
  const testimonials = [
    {
      quote:
        "RunBhumi changed my life. Their scouts discovered me in a small town league, and now I'm training with a national academy.",
      name: "Aditya Sharma",
    ...
    {
      quote:
        "The professional coaching and exposure I received through RunBhumi was better than anything I could have accessed in my hometown.",
      name: "Priya Patel",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white leading-tight">
              Real Stories from{" "}
              <span className="text-orange-500">Real Players</span>
            </h1>
            <p className="text-gray-300 text-lg">
              Hear from the athletes who found their path to professional
              cricket through RunBhumi's talent hunt programs.
            </p>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-8">
              <div className="text-white">
                ...
                <p className="text-orange-400">
                  From village grounds to IPL contract
                </p>
              </div>
            </div>
          </div>
