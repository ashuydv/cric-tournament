...
export const RegisterButton = () => {
    ...
    return (
        <div className="relative inline-block group">
            ...
            flex items-center gap-2 rounded-none rounded-tr-lg
          `}
                >
                    ...
                    <span className="absolute -bottom-6 left-0 right-0 text-xs font-medium text-red-600 bg-white px-2 py-1 rounded-b-md shadow-sm">
