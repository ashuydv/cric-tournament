        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-orange-50 to-orange-100">
            <div className="container mx-auto">
                <div className="flex flex-col sm:flex-row justify-start gap-4 mb-8">
                    <button
                        ...
                        className={`
            ${activeTab === 'vision' ? 'bg-orange-500 text-white shadow-xl' : 'bg-white text-gray-800 shadow-md hover:bg-orange-50'} 
          ...
          `}
                    ...
                    <button
                        ...
                        className={`
            ${activeTab === 'mission' ? 'bg-orange-500 text-white shadow-xl' : 'bg-white text-gray-800 shadow-md hover:bg-orange-50'} 
            font-medium px-8 py-6 
            transition-all duration-300 text-base
            flex items-center gap-2 rounded-xl
            italic uppercase w-full sm:w-auto
                    ...
                    {activeTab === 'vision' ? (
                        ...
                        >
                            <div className="space-y-4">
                                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl font-playfair">Our Vision</h2>
                        ...
                        >
                            <div className="space-y-4">
                                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl text-orange-500 font-playfair">Our Mission</h2>
