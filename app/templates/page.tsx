...
import { ArrowRight, Calendar, Trophy, Play, ChevronRight, Info, Smartphone, Star, MapPin, Check, Clock } from 'lucide-react'
...
const NewsletterSignup = () => (
    <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl shadow-lg w-full max-w-md">
        ...
        <p className="text-gray-300 mb-4">Get the latest news and tournament updates</p>
...
const FeaturedPlayers = () => (
    <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl shadow-lg w-full max-w-md">
        ...
        <div className="space-y-4">
            {[
                { name: 'Rajiv Sharma', position: 'Fast Bowler', rating: 4.9, location: 'Mumbai' },
                { name: 'Ananya Patel', position: 'All-Rounder', rating: 4.8, location: 'Bangalore' },
                { name: 'Vikram Singh', position: 'Batsman', rating: 4.7, location: 'Delhi' }
            ].map((player, index) => (
...
const UpcomingEvents = () => (
    <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl shadow-lg w-full">
        ...
        <div className="space-y-4">
            {[
                { name: 'Regional Qualifier - North', date: 'May 15, 2025', location: 'Delhi Stadium', spots: '32 spots remaining' },
                { name: 'Youth Cricket Camp', date: 'June 2-8, 2025', location: 'Mumbai Cricket Academy', spots: '18 spots remaining' },
                { name: 'National Finals', date: 'July 20, 2025', location: 'Bangalore International Stadium', spots: 'Qualification required' }
            ].map((event, index) => (
    ...
    <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl shadow-lg">
        ...
        <div className="mb-4">
            <div className="flex mb-2">
                {[1, 2, 3, 4, 5].map((star) => (
                    <Star key={star} size={18} className="text-yellow-400 fill-yellow-400 mr-1" />
                ))}
            </div>
            <p className="text-gray-300 italic">
                "RunBhumi changed my life completely. Coming from a small village in Rajasthan, I never thought I would get an opportunity to showcase my talent at the national level. The coaches and mentors at RunBhumi not only improved my cricket skills but also prepared me mentally for professional cricket."
            </p>
        </div>
...
const VideoFeature = () => (
    <div className="w-full h-full min-h-[350px] rounded-xl overflow-hidden relative">
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent z-10 flex items-end p-6">
            <div>
                <h3 className="text-xl font-bold text-white mb-2">Training Highlights</h3>
                <p className="text-gray-300 mb-4">Watch our expert coaches train future cricket stars with world-class techniques</p>
        ...
        <div className="min-h-screen bg-gray-900">
            ...
            <div className="bg-gray-800 py-6">
                <div className="container mx-auto px-4">
                    <h1 className="text-2xl md:text-3xl font-bold text-white">Hero Component Showcase</h1>
                    <p className="text-gray-400">Demonstrating different layout options and configurations</p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-12">
                <h2 className="text-2xl font-bold text-white mb-2">Left Content with Right Image</h2>
                <p className="text-gray-400 mb-8">Content on the left side, image on the right</p>
            </div>
            ...
            {/* Section Divider */}
            <div className="container mx-auto px-4 py-12">
                <h2 className="text-2xl font-bold text-white mb-2">Right Content with Left Image</h2>
                <p className="text-gray-400 mb-8">Content on the right side, image on the left</p>
            </div>
            ...
            {/* Section Divider */}
            <div className="container mx-auto px-4 py-12">
                <h2 className="text-2xl font-bold text-white mb-2">Left Content with Stats Component</h2>
                <p className="text-gray-400 mb-8">Content on the left side, custom stats component on the right</p>
            </div>
            ...
            {/* Section Divider */}
            <div className="container mx-auto px-4 py-12">
                <h2 className="text-2xl font-bold text-white mb-2">Right Content with Form Component</h2>
                <p className="text-gray-400 mb-8">Content on the right side, registration form on the left</p>
            </div>
            ...
            {/* Section Divider */}
            <div className="container mx-auto px-4 py-12">
                <h2 className="text-2xl font-bold text-white mb-2">Left Content with Newsletter Signup</h2>
                <p className="text-gray-400 mb-8">Content on the left side, newsletter signup on the right</p>
            </div>
            ...
            {/* Section Divider */}
            <div className="container mx-auto px-4 py-12">
                <h2 className="text-2xl font-bold text-white mb-2">Right Content with Video</h2>
                <p className="text-gray-400 mb-8">Content on the right side, video on the left</p>
            </div>
            ...
            {/* Section Divider */}
            <div className="container mx-auto px-4 py-12">
                <h2 className="text-2xl font-bold text-white mb-2">Left Content with Featured Players</h2>
                <p className="text-gray-400 mb-8">Content on the left side, featured players on the right</p>
            </div>
            ...
            {/* Section Divider */}
            <div className="container mx-auto px-4 py-12">
                <h2 className="text-2xl font-bold text-white mb-2">Right Content with Upcoming Events</h2>
                <p className="text-gray-400 mb-8">Content on the right side, upcoming events on the left</p>
            </div>
            ...
            {/* Section Divider */}
            <div className="container mx-auto px-4 py-12">
                <h2 className="text-2xl font-bold text-white mb-2">Left Content with Testimonial</h2>
                <p className="text-gray-400 mb-8">Content on the left side, testimonial on the right</p>
            </div>
            ...
            <div className="bg-gray-800 py-8 mt-12">
                <div className="container mx-auto px-4 text-center text-gray-400">
                    ...
                    <p className="text-sm mt-2">All designs and components for demonstration purposes</p>
                </div>
            </div>
        </div>
    )
