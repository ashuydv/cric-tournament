        ...
        <section className="py-8 bg-white border-b">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center">
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 font-playfair">
                Quick Navigation
              </h2>
              <div className="flex flex-wrap justify-center gap-3">
                <a
                  href="#registration"
                  className="px-4 py-2 bg-orange-100 text-orange-700 rounded-full hover:bg-orange-200 transition-colors flex items-center gap-1"
                >
              ...
              <div className="max-w-3xl mx-auto prose space-y-4 prose-orange lg:prose-lg">
                <div id="acceptance" className="terms-section scroll-mt-24">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <h2 className="text-2xl font-bold mt-0 font-playfair">
                      Acceptance of Terms
                    </h2>
                  </div>
                  <div className="pl-14">
                ...
                <div className="terms-section scroll-mt-24">
                  ...
                  <div className="pl-14">
                    <p className="text-gray-700">
                      ...
                      related services.
                      <br />
                      "User," "you," or "your" refers to the person accessing or
                      using RunBhumi services.
                      <br />
                      "Services" refers to the website, events, tournaments,
                      talent hunt programs, training camps, and other offerings
                      provided by RunBhumi.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="pl-14">
                    <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded-r-lg mb-4">
                      <p className="text-gray-800 italic">
                        "RunBhumi is a national movement dedicated to scouting,
                        training, and launching extraordinary cricket talent
                        from across India."
                      </p>
                    </div>
                    <p className="text-gray-700">
                      We aim to discover passionate players from cities to
                      remote villages who lack access, exposure, or opportunity
                      but possess exceptional potential. Through our platform,
                      we provide these talents with training, exposure, and a
                      pathway to professional cricket.
                    </p>
                    <p className="text-gray-700">
                      By participating in RunBhumi events or programs, you
                      acknowledge that you understand our mission and agree to
                      uphold the values of sportsmanship, dedication, and fair
                      play that RunBhumi stands for.
                    </p>
                  </div>
                </div>
                ...
                <div id="registration" className="terms-section scroll-mt-24">
                  ...
                  <div className="pl-14">
                    <p className="text-gray-700">
                      To participate in the RunBhumi Cricket Talent Hunt, you
                      must complete the registration process on our website or
                      through our official registration channels. Registration
                      includes providing accurate personal information including
                      but not limited to:
                    </p>
                    <ul className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                      <li className="flex items-start gap-2 mb-2">
                        ...
                        <span>
                          Full legal name (first, middle, and surname)
                        </span>
                      </li>
                      <li className="flex items-start gap-2 mb-2">
                        <div className="h-5 w-5 rounded-full bg-orange-200 flex items-center justify-center mt-0.5 flex-shrink-0">
                      ...
                      <li className="flex items-start gap-2 mb-2">
                        ...
                        <span>
                          Playing role and cricket-specific information
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          T-shirt size for official RunBhumi merchandise
                        </span>
                      </li>
                    </ul>
                    <p className="text-gray-700 mt-4">
                      By submitting your registration, you certify that all
                      provided information is accurate and complete. RunBhumi
                      reserves the right to verify any information provided and
                      to disqualify participants who provide false information.
                    </p>
                  </div>
                </div>
                ...
                <div className="terms-section scroll-mt-24">
                  ...
                  <div className="pl-14">
                    <div className="bg-gradient-to-r from-orange-50 to-amber-50 p-6 rounded-lg border border-orange-100 mb-4">
                      ...
                      <ul className="space-y-3">
                        ...
                        <li className="flex items-start gap-3">
                          ...
                          <span>
                            Opportunity to be selected for the 45-day Gurukul
                            training program
                          </span>
                        </li>
                        <li className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700">
                      RunBhumi does not guarantee selection for advanced stages
                      of the program, as this is based solely on merit and the
                      judgment of our cricket experts and selectors.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="pl-14">
                    <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg mb-4 border border-blue-100">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium text-blue-800">
                          Trials start: Thursday, April 18, 2025
                        </span>
                      </div>
                    ...
                    <ul className="space-y-2 my-4">
                      <li className="flex items-start gap-3 bg-gray-50 p-3 rounded-md">
                        ...
                        <span>
                          Appear at your selected trial location on the
                      ...
                      <li className="flex items-start gap-3 bg-gray-50 p-3 rounded-md">
                        <ArrowRight className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                        <span>
                          Follow all instructions from RunBhumi staff and
                          coaches
                        </span>
                      </li>
                      <li className="flex items-start gap-3 bg-gray-50 p-3 rounded-md">
                        <ArrowRight className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                        <span>
                          Comply with the venue's rules and regulations
                        </span>
                      </li>
                      <li className="flex items-start gap-3 bg-gray-50 p-3 rounded-md">
                        <ArrowRight className="h-5 w-5 text-orange-500 mt-0.5 flex-shrink-0" />
                        <span>
                          Maintain sportsmanlike conduct throughout the trial
                          process
                        </span>
                      </li>
                    </ul>
                  ...
                  <div className="pl-14">
                    ...
                    <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-r-lg my-4">
                      <p className="text-yellow-800">
                        <strong>Important:</strong> You are responsible for
                    ...
                    <div className="bg-gray-100 p-4 rounded-lg mb-4 border border-gray-200">
                      ...
                      <ul className="space-y-2">
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            All ticket sales are final and non-refundable unless
                            an event is canceled by RunBhumi
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-red-500 font-bold">•</span>
                          <span>
                            If canceled, refunds will be processed within 30
                            days
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-red-500 font-bold">•</span>
                          <span>
                            Tickets may not be resold or transferred without
                ...
                <div className="terms-section scroll-mt-24">
                  ...
                  <div className="pl-14">
                    <p className="text-gray-700">
                      ...
                      instructions from event staff, coaches, and mentors.
                    </p>
                    <div className="flex p-4 bg-red-50 rounded-lg my-4 border border-red-100">
                      ...
                      <p className="text-red-800 text-sm">
                        RunBhumi reserves the right to refuse entry or remove
                        any person from an event for any reason, including but
                        not limited to disruptive behavior, violation of rules,
                        or safety concerns.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="pl-14">
                    ...
                    <div className="bg-orange-50 p-4 rounded-lg border border-orange-100">
                      <p className="text-orange-800 text-sm">
                        ...
                        Violation of any code of conduct may result in immediate
                        disqualification from the program without refund of
                        registration fees.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="bg-gray-100 p-5 rounded-lg my-4 border border-gray-200">
                      ...
                      <ul className="space-y-2">
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            Film, photograph, and record your participation
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-orange-500 font-bold">•</span>
                          <span>
                            Use such content for promotional, broadcast, and
                            commercial purposes
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-orange-500 font-bold">•</span>
                          <span>
                            Share your cricket journey on television, social
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-orange-500 font-bold">•</span>
                          <span>
                            No additional compensation will be provided for such
                            usage
                          </span>
                        </li>
                      </ul>
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden mb-4">
                      ...
                      <div className="p-4">
                        ...
                        <p className="text-gray-700">
                          ...
                          of the material on our website without our prior
                          written consent.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="pl-14">
                    <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-r-lg mb-4">
                      <p className="text-red-800">
                        <strong>Important:</strong> RunBhumi shall not be liable
