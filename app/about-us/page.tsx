          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
              <div className="space-y-4">
                ...
                <p className="text-black md:text-lg">
                  With trials held across multiple countries, a rigorous 45 days
                  immersive cricket Gurukul led by legendary international
                  cricketers, and a grand league broadcast to audiences
                  worldwide,{" "}
                  <strong>
        ...
        {/* <section className="w-full py-8 sm:py-12 md:py-16 lg:py-24 xl:py-32">
          <div className="container px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 mx-auto max-w-7xl">
            <div className="flex flex-col items-center space-y-3 sm:space-y-4 text-center mb-8 sm:mb-10 lg:mb-12">
              ...
              <p className="max-w-[600px] lg:max-w-[700px] text-sm sm:text-base md:text-lg text-black px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20">
              <div className="flex flex-col items-center space-y-3 sm:space-y-4 max-w-lg mx-auto lg:max-w-none">
                ...
                <p className="text-xs sm:text-sm md:text-base text-black text-center max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg leading-relaxed px-2">
